...
runSyntheticSingle <- function(mydata = NULL, opt.list = NULL, run.list = NULL, ireal = 1, iseed = NULL) {
    ...
    success = saveRData(mydata = mydata, all_years_epi = NULL, run.input = run.input, ireal = ireal, subDir = run.list$subDir)
...
runSyntheticMulti <- function(mydata = NULL, opt.list = NULL, run.list = NULL, ireal = 1, iseed = NULL) {
    ...
    success = synthetic.compare(tab.fit = tab, tab.cpl = tab.cpl, mydata = mydata, fit_par = save_fit_par, cpl_par = save_cpl_par, opt.list = opt.list,
